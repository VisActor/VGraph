import { DAGFlowEditor, GraphEvent, Node, uuid, Graph, registerEdge, highlightRelations, attachableDragNode, Edge } from '../../src';
...
(() => {
  ...
  btnExport.onclick = () => {
    console.log(editor.exportData(undefined, (edge: Edge) => ({
      label: 'mock label',
      configs: {
        a: 1,
        b: 2
