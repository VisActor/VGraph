...
function collapse(shape: Shape, graph: Graph, fdp: ForceDirectedLayout, fdGrouping: ForceDirectedGrouping) {
...
function expand(node: any, graph: Graph, fdp: ForceDirectedLayout, fdGrouping: ForceDirectedGrouping) {
