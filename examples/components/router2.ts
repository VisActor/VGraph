import { dragCanvas, Graph, panZoom, dragNode, highlightRelations, Edge, DAGLayout, fastrand, GraphStructure } from '../../src';
...
(() => {
  ...
  for (const edge of graph.getEdges()) {
    ...
    //     edge.setState('show');
    // }
    if (edge.get('id') === '8498790c-7fc5-4d22-99d9-8035174a8dc2-4249daa6-5145-47df-8a0a-03da78907a79') {
