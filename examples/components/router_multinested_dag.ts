...
import {
  dragCanvas, Graph, panZoom, Text, highlightRelations,
  Group, Icon, textUtil, Edge, NestedDAG, uuid, Layer, Rect
} from '../../src';
...
(() => {
  ...
  const router = new Router(gridComponent, { allowDiagonal: 'never', minDist: 20 });
