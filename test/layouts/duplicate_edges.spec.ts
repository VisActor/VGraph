...
describe('src/utils/duplicate_edges.ts', () => {
  ...
  it('default line should work', () => {
    ...
    expect(edges[2].get('controlPoints')).toEqual([[47.878679656440355, 47.878679656440355]]);
    expect(edges[3].get('controlPoints')).toEqual([[52.121320343559645, 52.121320343559645]]);
    expect(edges[4].get('controlPoints')).toEqual([[-47.878679656440355, 47.878679656440355]]);
    expect(edges[5].get('controlPoints')).toEqual([[-52.121320343559645, 52.121320343559645]]);
    expect(edges[6].get('controlPoints')).toEqual([[-150, 50]]);
    expect(edges[7].get('controlPoints')).toEqual([[-154.2426406871193, 45.757359312880716]]);
    expect(edges[8].get('controlPoints')).toEqual([[-145.7573593128807, 54.242640687119284]]);
  });
  ...
  it('hLine with scale parameter should work', () => {
    ...
    expect(edges[2].get('controlPoints')).toEqual([[50, 100], [50, 0]]);
    expect(edges[3].get('controlPoints')).toEqual([[40, 100], [40, 0]].reverse());
    expect(edges[4].get('controlPoints')).toEqual([[60, 100], [60, 0]].reverse());
    expect(edges[5].get('controlPoints')).toEqual([[-145, 0], [-145, 100]]);
    expect(edges[6].get('controlPoints')).toEqual([[-155, 0], [-155, 100]].reverse());
  });
  ...
  it('hLine with controlPoints should work', () => {
    graph.data({
      ...
      edges: [
        { source: '0', target: '1', type: 'hLine', controlPoints: [[40, -20], [80, -20]] },
        { source: '0', target: '1', type: 'hLine', controlPoints: [[40, -20], [80, -20]] },
        { source: '2', target: '1', type: 'hLine', controlPoints: [[40, 20], [80, 20]] },
        { source: '1', target: '2', type: 'hLine', controlPoints: [[40, 20], [80, 20]] },
        { source: '1', target: '2', type: 'hLine', controlPoints: [[40, 20], [80, 20]] },
      ],
    });
    dealDuplicateEdge(graph, graph.getEdges());
    const edges = graph.getEdges();
    expect(edges[0].get('controlPoints')).toEqual([[40, -17], [80, -17]]);
    expect(edges[1].get('controlPoints')).toEqual([[40, -23], [80, -23]]);
    expect(edges[2].get('controlPoints')).toEqual([[40, 20], [80, 20]]);
    expect(edges[3].get('controlPoints')).toEqual([[80, 14], [40, 14]]);
    expect(edges[4].get('controlPoints')).toEqual([[80, 26], [40, 26]]);
  });
  ...
  it('vLine with controlPoints should work', () => {
    graph.data({
      ...
      edges: [
        { source: '0', target: '1', type: 'vLine', controlPoints: [[40, -10], [80, -20]] },
        { source: '0', target: '1', type: 'vLine', controlPoints: [[40, -10], [80, -20]] },
        { source: '2', target: '1', type: 'vLine', controlPoints: [[40, 10], [80, 20]] },
        { source: '1', target: '2', type: 'vLine', controlPoints: [[40, 10], [80, 20]] },
        { source: '1', target: '2', type: 'vLine', controlPoints: [[40, 10], [80, 20]] },
      ],
    });
    dealDuplicateEdge(graph, graph.getEdges());
    const edges = graph.getEdges();
    expect(edges[0].get('controlPoints')).toEqual([[43, -10], [83, -20]]);
    expect(edges[1].get('controlPoints')).toEqual([[37, -10], [77, -20]]);
    expect(edges[2].get('controlPoints')).toEqual([[40, 10], [80, 20]]);
    expect(edges[3].get('controlPoints')).toEqual([[74, 20], [34, 10]]);
    expect(edges[4].get('controlPoints')).toEqual([[86, 20], [46, 10]]);
  });
});
