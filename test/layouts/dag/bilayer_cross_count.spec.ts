...
describe('src/bilayer_cross_count', () => {
  it('should calculate cross counts', () => {
    ...
    expect(bilayerCrossCount([graph.getNodeById('1'), graph.getNodeById('2')], [graph.getNodeById('3'), graph.getNodeById('4')])).toBe(
      1
    );
  ...
  it('should work when there is no cross', () => {
    ...
    expect(bilayerCrossCount([graph.getNodeById('1'), graph.getNodeById('2')], [graph.getNodeById('3')])).toBe(0);
    expect(bilayerCrossCount([graph.getNodeById('1'), graph.getNodeById('2')], [graph.getNodeById('3')], graph.getEdges())).toBe(0);
  });
});
