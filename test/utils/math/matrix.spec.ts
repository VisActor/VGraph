import { isMathEqual, degToRadian, translate, rotate, scale, invert, multiply } from '../../../src/utils/math';
...
describe('src/math/matrix', () => {
  ...
  it('rotate should work', () => {
    ...
    expect(matrix).toEqual([Math.SQRT2 / 2, -Math.sin(Math.PI / 4), Math.sin(Math.PI / 4), Math.SQRT2 / 2, 0, 0]);
  });
