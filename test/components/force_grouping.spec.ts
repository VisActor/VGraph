...
describe('ForceDirectedGrouping', () => {
  ...
  describe('setOptions and config shapeStyle should work', () => {
    ...
    const shapes = Object.entries(forceGrouping.getGroupShapes((v) => v === 0 || v === 3)).map((d) => d[1]) as Shape[];
  ...
  describe('updateData should work', () => {
    ...
    let shapes = Object.entries(fdGrouping.getGroupShapes((v) => v === 0 || v === 3)).map((d) => d[1]) as Shape[];
    expect(shapes.length).toBe(2);
