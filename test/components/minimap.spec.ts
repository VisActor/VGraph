...
describe('src/minimap', () => {
  ...
  it('delegate minimap should work', () => {
    ...
    expect(canvas.children[0].getMatrix()).toEqual([0.16666666666666666, 0, 0, 0.16666666666666666, 98, 48]);
  ...
  it('showEdges & setEdgeStyles should work', (done) => {
    ...
    expect(edge.get('path')).toEqual(graph.getEdges()[0].getKeyShape().get('path'));
