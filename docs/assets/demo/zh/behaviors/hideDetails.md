...
当默认情况下是看局部细节的时候，比如初始状态会聚焦到根节点，或者最近一个没有完成的流程等，VGraph 提供<a href="/vgraph/guide/behaviors#hideDetails-隐藏细节">缩小展示全局时隐藏细节</a>的交互，可以在全局状态下关注节点的最主要信息。辅助以点击聚焦节点方便在全局状态下再聚焦到个体。
