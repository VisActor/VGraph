...
Data description: A common layout method for single-chain relationship data. This instance implements a way to limit the number of nodes in a single row and can automatically refresh the layout when data in the graph is added, deleted, or modified.
