...
Data description: A relationship graph of "Dream of the Red Chamber" with connection relationships removed and depth randomly assigned. The color represents the depth of the node relative to the central node, and it can be seen that this layout allows nodes to be evenly distributed on concentric rings.
