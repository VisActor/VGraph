...
The node flash animation is often used to lightly focus on a single node. For example, in this case, the find node function will move the node to the center of the viewport and use a flash animation for a light focus.
