...
category: examples
group: editor
title: Directed Graph Free Editing - Duplicate Edges
cover:
...
export const Toolbar = ({ editor }) => {
  ...
  const modeMap = { edit: 'Edit', read: 'Read-only', 'read-lax': 'Read-only-Lax' };
  const actions = [
    { name: 'Export Data', handler: () => console.log(JSON.stringify(editor.exportData())) },
    { name: 'Undo', handler: () => editor.undo() },
    { name: 'Redo', handler: () => editor.redo() },
    { name: 'Zoom In', handler: () => graph.scale(1.1) },
    { name: 'Zoom Out', handler: () => graph.scale(0.9) },
    { name: 'Focus Node', handler: () => { const s = editor.getSelection(); if (s.node.length) graph.focus(graph.getNodeById(s.node[0])); } },
    { name: 'Brush Select', handler: toggleBrushSelect },
    { name: 'Clear Canvas', handler: () => editor.clear(), disabled: modeState !== 'edit' },
    { name: 'Copy', handler: () => editor.copy() },
    { name: 'Paste', handler: () => editor.paste() },
    { name: 'Cut', handler: () => editor.cut() },
    { name: `Toggle Mode, Current: ${modeMap[modeState]}`, handler: toggleMode }
  ];
  const iconMap = {
    'Export Data': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc96691.svg',
    'Undo': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc96d7.svg',
    'Redo': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc96d84.svg',
    'Zoom In': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc97939.svg',
    'Zoom Out': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc96930.svg',
    'Focus Node': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc97164.svg',
    'Brush Select': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18f04b44b5e34.svg',
    'Clear Canvas': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc97141.svg',
    'Copy': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc97484.svg',
    'Paste': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc9705.svg',
    'Cut': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc9694.svg',
    'Toggle Mode': 'https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VGraph/site-demo/file_18ef55fc9753.svg'
  };
  ...
  return (
    <div style={{ width: 'calc(100% - 108px)', position: 'absolute', right: 0, top: 8, zIndex: 1, height: 28, overflow: 'auto', display: 'flex', justifyContent: 'flex-end' }}>
      {actions.map(item => (
        <Tooltip key={item.name} content={item.disabled ? `${item.name}(Read-only mode disabled)` : item.name}>
          <span
          ...
          >
            <img
              ...
              height="18px"
              src={
                item.name.indexOf('Toggle Mode') >= 0
                  ? iconMap['Toggle Mode']
                  : iconMap[item.name]
              }
            />
