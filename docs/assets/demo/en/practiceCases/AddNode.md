...
Click the plus icon on a node to add a child node in a compact tree; automatically determine whether to move the view to ensure the new node is visible.
