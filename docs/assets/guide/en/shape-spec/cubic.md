...
A Cubic Bezier Curve (Cubic) is a graphic object used to create a cubic Bezier curve graphic instance, containing information such as the curve's control points and arrows, for the rendering engine to draw and interact with.
...
| --- | --- | --- |
| points | number[][] | A 4x2 two-dimensional array, where each one-dimensional array represents a control point coordinate, for a total of four control points. |
