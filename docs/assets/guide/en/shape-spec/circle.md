...
A Circle is a graphic object used to create a circular graphic instance, containing information such as the circle's coordinates and radius, for the rendering engine to draw and interact with.

## Example

```js
import { Circle } from '@visactor/vgraph';
...
<p><img src="/vgraph/guide/shape/circle.png" width="300"></p>
