...
An Image is a graphic object used to create an image graphic instance, containing information such as the image's position, size, and image texture, for the rendering engine to draw and interact with.

## Example

```typescript
import { Image } from '@visactor/vgraph';
...
<p><img src="/vgraph/guide/shape/image.jpg" width="300"></p>

## Image Configuration

| Field | Type | Description |
| --- | --- | --- |
| left | number | The left coordinate of the image. |
| top | number | The top coordinate of the image. |
| width | number | The width of the image. |
| height | number | The height of the image. |
| url | string \| object | The source path of the image. |

> Note: For the `left`, `top`, `width`, and `height` configurations, refer to [Rect](/vgraph/guide/shape-spec/rect).
