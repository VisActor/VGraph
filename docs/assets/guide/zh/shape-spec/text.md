...
文字 Text 是图形对象的一种，用于创建一个文字的图形实例，包含文字的内容、位置、大小、字体等信息，用于渲染引擎进行绘制及交互操作。
...
| y            | number                                                                       | 文字 y 坐标                                                                                                                                                                                                                                                             |
| width        | number                                                                       | 文字最大宽度                                                                                                                                                                                                                                                            |
| height       | string \| object                                                             | 文字最大高度                                                                                                                                                                                                                                                            |
| textOverflow | 'clip' \| 'ellipsis'                                                         | 文字溢出，当文字内容超出 width 或 height 指定的宽高时发生溢出。`clip`表示裁剪溢出的文字，`ellipsis`表示用`...`表示溢出的文字。默认值为`clip`。可参考[CSS text-overflow](https://developer.mozilla.org/zh-CN/docs/Web/CSS/text-overflow)                                 |
| textAlign    | 'start' \| 'center' \| \'end' \| 'left' \| 'right'                           | 文本横向对齐方式，若设置为`start`或`left`，则此时的 x 表示文本左侧坐标；若设置为`center`，则 x 表示文本中心 x 坐标；若设置为`end`或`right`，则 x 表示文本右侧坐标。默认值为`start`。可参考[CSS text-align](https://developer.mozilla.org/zh-CN/docs/Web/CSS/text-align) |
| textBaseline | 'top' \| 'hanging' \| \'middle' \| 'alphabetic' \| 'ideographic' \| 'bottom' | 文本垂直向对齐方式，默认值为`top`, 若设置为`top`或`hanging`，则此时的 y 表示文本顶部坐标；若设置为`middle`，则 y 表示文本中心 y 坐标；若设置为`alphabetic`，`ideographic` 或 `bottom`，则 y 表示文本底部坐标                                                            |
| fontSize     | number                                                                       | 字体大小，默认值为 12 .                                                                                                                                                                                                                                                 |
| lineHeight   | number                                                                       | 行高                                                                                                                                                                                                                                                                    |
| fontStyle    | 'normal' \| 'italic' \| 'oblique'                                            | 字体样式，可参考[CSS font-style](https://developer.mozilla.org/zh-CN/docs/Web/CSS/font-style)                                                                                                                                                                           |
| fontVariant  | 'normal' \| 'small-caps'                                                     | 字体变体，可参考[CSS font-vatiant](https://developer.mozilla.org/zh-CN/docs/Web/CSS/font-variant)                                                                                                                                                                       |
| fontWeight   | 'normal' \| 'bold' \| 'bolder' \| 'lighter' \| number                        | 字体的粗细程度，可参考[CSS font-weight](https://developer.mozilla.org/zh-CN/docs/Web/CSS/font-weight)                                                                                                                                                                   |
| fontFamily   | string                                                                       | 字体家族，可参考[CSS font-family](https://developer.mozilla.org/zh-CN/docs/Web/CSS/font-family)                                                                                                                                                                         |
...
| isOverflow()                                 | boolean   | 文本是否溢出，只有文本设置了 宽度的情况下可能会溢出。          |
