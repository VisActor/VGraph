...
import { EdgeData, GroupData, NodeData, GraphStructureData } from '../typings/data';
...
export class GraphStructure {
  ...
  entityMap: {
    ...
    group: {[x: string]: GroupData}} = {} as any;
  ...
  initEdge(edgeData: Partial<EdgeData>, temp = false) {
    ...
    if (sourceNode && targetNode) {
      const edge = new EdgeStructure(Object.assign(edgeData, {
        id,
        source,
        target,
      }));
