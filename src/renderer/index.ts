...
import {
  isPointIntersect, isRectIntersect, isPathIntersect,
  getNearestPoint, getCircleIntersect, getRectIntersect,
  pointToRectDist
...
export {
  ...
  CanvasConfigs, AnimationConfigs, Shape
...
export const IntersectUtil = {
  isPointIntersect, isRectIntersect, isPathIntersect,
  getNearestPoint, getCircleIntersect, getRectIntersect, pointToRectDist
};
