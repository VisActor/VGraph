...
// https://www.figma.com/file/9DZW5QHmVjGczKVXrIzWkP/%F0%9F%93%88rq-xGraph%E5%9B%BE%26%E8%A7%84%E8%8C%83?node-id=2667-88829&t=v4Ogik5fWTy3nI4L-0
export function init(layer: Layer, options: LinkOptions) {
  const { x, y, disabled, text, maxWidth, icon, align, label, underline } = options;
