...
export { CategoryLegend, ContinuousLegend, CategoryLegendOptions, ContinuousLegendOptions, CategoryLegendDataItem } from './legend';
...
export {
  Stack, CommandBase, AddCommand, SelectCommand, RemoveCommand, CopyCommand, CutCommand, PasteCommand, MoveNodeCommand, UpdateCommand,
  BatchCommand, InsertNodeCommand, generateSnapshot, execClipboardEvent, getStackSelections, LayoutCommand, getDefaultShortcuts
} from './stack'