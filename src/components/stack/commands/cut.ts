...
import { isEmptySelections, getSelectionsSnapshot, getCleanSnapshot, batchRemove, batchAdd } from './utils';
...
export const CutCommand = Object.assign({}, CommandBase, {
  ...
  execute(snapshot: { removeConfigs: { node: any[], edge: any[], group: any[] } }, graph: Graph) {
